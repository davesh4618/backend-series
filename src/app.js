...
app.use(express.static("public")) /*app.use(express.static("public")) is a built-in middleware function in Express that tells your server to serve static files (like raw HTML, CSS images, PDFs, or frontend JavaScript files) directly to the browser from a folder named public.
